...
def pytest_addoption(parser):
    ...
    parser.addoption('--language', action='store', default=None, help="Choose language: ru or en") # добавляем возможность выбора языка для запуска теста, по умолчанию не выбран ни один
